...
# 📖 Fonte: Constituição Federal, Art. 5º, VI, VII, VIII, IX, LIV, LXXVII, Art. 210, 215, 216
# 📜 Fundamentação: Convenção 169 da OIT | Lei 9.610/98 | Art. 12 do Pacto de San José da Costa Rica | ONU

cat << 'DOC' > fundamento_legal_constituinte.md
# 📜 Fundamento Legal – CientiEspiritual
...
git commit -m "📜 Fundamento legal e convenções internacionais adicionadas"
